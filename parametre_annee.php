...
<div class="panel panel-primary">
            ...
            <h3 class="panel-title">CONFIGURATION DES ANNEES</h3>
            </div>
            <div class="panel-body">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="panel-body">
                <tr>
                  <td width="47%"><form name="testform" method="post" action="parametre_annee_save.php">
...
<form name="form2" method="post" action="produit_cancel.php">
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
      ...
      <td width="266" align="center" bgcolor="#3071AA">&nbsp;</td>
      <td width="313" align="center" bgcolor="#3071AA" ><font color="#FFFFFF">Année</font></td>
