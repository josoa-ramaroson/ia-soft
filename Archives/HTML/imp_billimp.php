    ...
    <td width="57%"><table width="100%" border="1">
      <tr>
        <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td>ID Client :<span style="width:36%"><? echo $data5['id'];?></span></td>
            <td>Police : <span style="width:36%"><? echo $data5['Police'];?></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><span style="width:36%">Type de compteur :<? echo $data5['typecompteur'];?></span></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
<p align="center">DATE LIMITE DE PAIEMENT : <b> <? echo $datcoupure; ?> </b> &nbsp;&nbsp;</p>
  ...
  <div class="panel-body">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <p>Police : <span style="width:36%"><? echo $data5['Police'];?></span> DATE : </p></td>
