...
$sql5="SELECT * FROM $tbl_contact c , $tbl_fact f WHERE c.id=f.id  and  nserie='$nserie' and st='E' and ville='$m1' and quartier='$m2'";
    ...
    <td width="57%"><table width="100%" border="1">
      <tr>
        <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td>ID Client :<span style="width:36%"><?php echo $data5['id'];?></span></td>
            <td>Police : <span style="width:36%"><?php echo $data5['Police'];?></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
<p align="center">DATE LIMITE DE PAIEMENT : <b> <?php echo $datcoupure; ?> </b> &nbsp;&nbsp;</p>
