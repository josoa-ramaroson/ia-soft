...
<div class="panel panel-primary">
            ...
            <h3 class="panel-title">Service contrôle  </h3>
            </div>
            <div class="panel-body">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="panel-body">
                <tr>
                  <td width="47%"><form name="form1" method="post" action="client_controle_save.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><input name="Facturation" type="text" disabled class="form-control" id="Facturation" value="SERVICE DE CONTROLE" size="50" readonly></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td><select name="Probleme" id="Probleme">
                          <option selected>Compteur</option>
                          <option>Disjoncteur</option>
                          <option>Plomber</option>
                          <option>Amperage </option>
                        </select></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
