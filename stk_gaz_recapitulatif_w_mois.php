...
?></td>
  ...
  <?php
$sql1="SELECT MONTHNAME(datev)AS mois, YEAR(datev) AS annee , SUM(PTotal) AS prix  FROM $tbl_vente  where type=1 GROUP BY YEAR(datev),MONTHNAME(datev) ";
  ...
  <tr> 
    <td><form name="form2" method="post" action="formationsupprime1_question.php">
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr bgcolor="#993300"> 
            <td width="13%" align="center" bgcolor="#0033FF"><font color="#CCCCCC" size="3"><strong>ANNEE</strong></font></td>
            <td width="36%" align="center" bgcolor="#0033FF"><font color="#CCCCCC" size="4"><strong>MOIS</strong></font></td>
            <td width="20%" align="center" bgcolor="#0033FF"><font color="#CCCCCC" size="3">&nbsp;</font></td>
