        ...
        <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="64%"><font color="#000000"><strong><?php echo $datam['Designation'];?></strong>
              <?php $nomprenom=substr($datam['nomprenom'],0,22); echo $nomprenom;?>
            </font></td>
          </tr>
          <tr>
            <td>Fonction</td>
          ...
          <tr>
            ...
            <td><strong>
              <?php $dembauche=$datam['dembauche'];  echo  date("d-m-Y", strtotime($dembauche));?>
            </strong></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="31%"> Fonction </td>
            <td width="20%"><?php echo $datam['fonction']; ?></td>
          </tr>
          <tr>
            <td>Taux </td>
          ...
          <tr>
            ...
            <td> Téléphone </td>
            <td><?php echo $datam['telephone']; ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td>SALAIRE NET </td>
            <td><strong> <?php echo $datam['SNET']; ?> KMF</strong></td>
          </tr>
        </table></td>
      </tr>
    </table>
