...
<div class="panel-heading">
  <h3 class="panel-title">Ajouter les directions </h3>
</div>
 <div class="panel-body">
 
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr> 
    <td width="47%"><form name="form1" method="post" action="rh_direction_save.php">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <td><input class="form-control" name="direction" type="text" id="direction" value="" size="40"></td>
          </tr>
        <tr> 
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
?>
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
    <tr bgcolor="#000000"> 
      ...
      <td width="35%" align="center" bgcolor="#0033FF"><font color="#CCCCCC">Direction</font> 
        </td>
