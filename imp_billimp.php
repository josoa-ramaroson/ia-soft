                ...
                <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="71%"><font color="#000000">
                      <?php $client=substr($data5['nomprenom'],0,22); echo $client;?>
                    </font></td>
                  </tr>
                  <tr>
                    <td>Adresse :</td>
                  ...
                  <tr>
                    <td>ID Client :</td>
                    <td><span style="width:36%"><?php $Codebare=$data5['id']; echo $data5['id'];?> Type de compteur :<?php echo $data5['typecompteur'];?></span></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
