...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
      ...
      <a href="rh_employer_paie.php" class="btn btn-sm btn-success" > Traitement par Agent </a> |
      <a href="rh_employer_paie_global.php" class="btn btn-sm btn-success" > Traitement en groupe</a> |
      <a href="rh_bulletin_type.php" class="btn btn-sm btn-success" > Bulletins </a> |
      <a href="rh_employer_sbase.php" class="btn btn-sm btn-success" > T.SBase</a> | 
      <a href="rh_employer_sind.php" class="btn btn-sm btn-success" > T.Indemnites</a> | 
      <a href="rh_employer_sdeduction.php" class="btn btn-sm btn-success" > T.Deductions</a> | 
      <a href="rh_employer_retenues.php" class="btn btn-sm btn-success" > T.Retenues</a> | 
      <a href="rh_employer_recapitulatif.php" class="btn btn-sm btn-success" > Recapitulatif</a> | 
