...
<body>
 <p>
En attente de payer sa police d'Abonnement  </p>
 <p>
   <?php
$sql = "SELECT count(*) FROM $tbl_contact  where statut='1'";  
...
$sql = "SELECT * FROM $tbl_contact  where statut='1' ORDER BY nomprenom ASC LIMIT ".$_GET['debut'].",".$nb_affichage_par_page;  
...
?>
   <tr>
     ...
     <td align="center" bgcolor="#FFFFFF"><a href="re_affichage_user.php?id=<?php echo md5(microtime()).$data['id']; ?>" class="btn btn-sm btn-default" >Aperçu</a></td>
   </tr>
   <?php
}
