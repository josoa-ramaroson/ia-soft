...
?>
      ...
      <tr>
        <td>Nouveau Index</td>
        <td><em>
          <input name="nfi2" type="text" disabled id="nfi2" value="<?php echo $rows3['nf2']; ?>" size="30" readonly>
        nuit</em></td>
        <td>&nbsp;</td>
        <td><em>
      ...
      <tr>
        <td>Ancien Index</td>
        <td><em>
          <input name="n2" type="text" id="n2" value="<?php echo $rows3['n2']; ?>" size="30" readonly>
        </em></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <td><input name="impayee3" type="text" id="impayee3" value="<?php echo $rows3['impayee']; ?>" size="30" readonly></td>
...
?>
      ...
      <tr>
        ...
        <td><input name="impayee2" type="text" id="impayee2" value="<?php echo $rows3['Pre']; ?>" size="30" readonly></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><em>
          ...
          <input name="nfi2" type="hidden" id="nfi2" value="<?php echo $rows3['nf2'];?>">
