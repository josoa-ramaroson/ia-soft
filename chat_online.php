...
$reqnb = mysqli_query($linki,$sqlnb) or die('Erreur SQL !<br />'.$sqlnb.'<br />'.mysqli_error());  
...
$req2nb = mysqli_query($linki,$sql2nb) or die ('Erreur SQL !<br />'.$sql2nb.'<br />'.mysqli_error());  
?> 
<?php
...
$reqaf = mysqli_query($linki,$sqlaf) or die('Erreur SQL !<br />'.$sqlaf.'<br />'.mysqli_error());  
