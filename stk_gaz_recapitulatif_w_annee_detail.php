...
<p>&nbsp;</p>
<a href="stk_gaz_recapitulatif_w_annee_detailimp.php?annee=<?php echo md5(microtime()).$annee; ?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a>
