...
?>
     ...
     <td width="30%"><div class="panel panel-primary">
       ...
       <div class="panel-body">
         <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
           <tr>
             <td width="47%"><form action="stat_graph_fact.php" method="post" name="form1" id="form3">
               <font color="#000000">
                 <select name="annee" size="1" id="annee">
                   <?php
$sql81 = ("SELECT * FROM annee  ORDER BY annee ASC ");
...
?>
     ...
     <td width="30%"><div class="panel panel-primary">
       ...
       <div class="panel-body">
         <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
           <tr>
             <td width="47%"><form action="stat_graph_rec.php" method="post" name="form1" id="form4">
               <font color="#000000">
                 <select name="annee" size="1" id="annee">
                   <?php
$sql81 = ("SELECT * FROM annee  ORDER BY annee ASC ");
...
?>
     ...
     <td width="30%"><div class="panel panel-primary">
       ...
       <div class="panel-body">
         <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
           <tr>
             <td width="47%"><form action="stat_graph_dis_fac.php" method="post" name="form1" id="form5">
               <font color="#000000">
                 <select name="annee" size="1" id="annee">
                   <?php
$sql81 = ("SELECT * FROM annee  ORDER BY annee ASC ");
...
?>
               ...
               <input type="submit" name="valider5" id="valider4" value="Valider" />
             </form></td>
           </tr>
         </table>
       </div>
     ...
     <td width="30%"><div class="panel panel-primary">
       ...
       <div class="panel-body">
         <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
           <tr>
             <td width="47%"><form action="stat_graph_fac_rec.php" method="post" name="form1" id="form6">
               <font color="#000000">
                 <select name="annee" size="1" id="annee">
                   <?php
$sql81 = ("SELECT * FROM annee  ORDER BY annee ASC ");
...
?>
               ...
               <input type="submit" name="valider6" id="valider6" value="Valider" />
             </form></td>
           </tr>
         </table>
       </div>
  ...
  <tr>
    <td width="34%"><div class="panel panel-primary">
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="stat_graph_pro_dis_fac.php" method="post" name="form1" id="form9">
              <font color="#000000">
                <select name="annee" size="1" id="annee">
                  <?php
$sql81 = ("SELECT * FROM annee  ORDER BY annee ASC ");
...
?>
              ...
              <input type="submit" name="valider9" id="valider9" value="Valider" />
            </form></td>
          </tr>
        </table>
      </div>
    ...
    <td width="30%"><div class="panel panel-primary">
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="stat_graph_fac_rec_client.php" method="post" name="form1" id="form8">
...
?>
              ...
              <input type="submit" name="valider8" id="valider8" value="Valider" />
            </form></td>
          </tr>
        </table>
      </div>
    ...
    <td width="30%"><div class="panel panel-primary">
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="stat_graph_sclient.php" method="post" name="form1" id="form7">
...
?>
              ...
              <input type="submit" name="valider7" id="valider7" value="Valider" />
            </form></td>
          </tr>
        </table>
      </div>
  ...
  <tr> 
    <td height="21"><div class="panel panel-warning">
      <div class="panel-heading">
        <h3 class="panel-title">ARCHIVES  </h3>
      </div>
      <div class="panel-body"> <a href="z_stat_tableau.php" class="btn btn-sm btn-warning" >  REPRESENTATION GRAPHIQUE </a> | </div>
    </div></td>
</tr>
<tr> 
    <td height="21"><p>&nbsp;</p>
