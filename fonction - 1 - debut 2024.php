<?	
		...
		$annee_facturation='2023';   // changer en debut FACTURATION JANVIER 4
		$annee_recouvrement='2023';  // changer A PARTIR DE 15 FEVRIER       5
			
		
	    // gestion des dates pour les archives
		$annee1A="2015";
		$annee2A="2022";            // changer en MI- MARS  APRES ARCHIVAGE_ 6 
		$date1A="2015-07-01";
		$date2A="2022-12-31";       // changer en MI- MARS  APRES ARCHIVAGE  7
