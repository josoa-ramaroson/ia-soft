...
?>
    ...
    <p align="center"> &nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $data5['nserie'].'/'.$data5['fannee']; ?></b></p></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
      ...
      <tr>
        <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="71%"><font color="#000000"><?php $client=substr($data5['nomprenom'],0,18); echo $client;?></font></td>
          </tr>
          <tr>
            <td>Adresse :</td>
            <td><span style="width: 40%; text-align: left"><span style="width:36%"><?php $ville=substr($data5['ville'],0,18); echo $ville;?></span> <span style="width:36%"><?php echo $data5['quartier'];?></span></span></td>
          </tr>
          <tr>
            <td>ID Client :</td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><span style="width:36%">Type de compteur :<?php echo $data5['typecompteur'];?></span></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
<p align="center">DATE LIMITE DE PAIEMENT : <b> <?php echo  date("d-m-Y", strtotime($datcoupure)); ?> </b> &nbsp;&nbsp;</p>
  ...
  <tr>
    <td><table width="99%" border="0" align="center">
      ...
      <tr>
        ...
        <td><span style="width:36%"><?php echo $data5['amperage'];?></span> A</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><span style="width:36%"><b><?php echo $data5['totalnet'];?></b></td>
        <td>KMF</td>
      </tr>
    </table></td>
  </tr>
...
<div class="panel panel-info">
  <div class="panel-heading">
    <h3 class="panel-title">RECU DE : <font color="#000000"><?php echo $client;?></font></h3>
  </div>
  <div class="panel-body">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
      <tr>
  ...
  <div class="panel-body">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <p>ADRESSE : <span style="width: 40%; text-align: left"><span style="width:36%"><?php $ville=substr($data5['ville'],0,18); echo $ville;?></span> - <span style="width:36%"><?php echo $data5['quartier'];?></span></span></p>
        <p>Police : <span style="width:36%"><?php //echo $data5['Police'];?></span> DATE : </p></td>
