...
<a href="bcaisse_slieu.php" class="btn btn-xs btn-success" > Ajouter une institution financière </a> |

</div>

<div class="panel panel-primary">
            <div class="panel-heading">
            <h3 class="panel-title">les versements auprès de la banque </h3>
            </div>
            <div class="panel-body">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="panel-body">
                <tr>
                  <td width="47%"><form name="testform" method="post" action="bcaisse_ver_save.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><select name="Institution" id="Institution">
                          <?php
$sql2s ="SELECT * FROM $tbl_caisse_lieu ORDER BY organisme  ASC ";
$result2s = mysqli_query($linki,$sql2s);
while ($row2s = mysqli_fetch_assoc($result2s)) {
echo '<option value='.$row2s['idl'].'> '.$row2s['organisme'].' </option>';
}
...
?>
					  ...
					  ?></td>
                        <td>&nbsp;</td>
                        <td>N° de versement </td>
                        <td><input name="nversement" type="text" class="form-control" id="nversement" size="50"></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        <td>Montant </td>
                        <td><input name="Montant" type="text" class="form-control" id="Montant" size="50"> </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
...
$sql = "SELECT count(*) FROM $tbl_caisse_ver ";  
...
$sql = "SELECT * FROM $tbl_caisse_ver  ORDER BY idV DESC LIMIT ".$_GET['debut'].",".$nb_affichage_par_page;  //ASC
...
<form name="form2" method="post" action="produit_cancel.php">
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
      ...
      <td width="192" align="center" bgcolor="#3071AA" ><font color="#FFFFFF">Montant </font></td>
    </tr>
    <?php
...
<script language="JavaScript" type="text/javascript" xml:space="preserve">//<![CDATA[
  var frmvalidator  = new Validator("testform");
    ...
    frmvalidator.addValidation("Montant","req","SVP enregistre le libelle");
</script>