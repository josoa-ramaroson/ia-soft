  ...
  <tr>
    <td width="63%"><div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"> Affichage des alertes par Ville et Quartier</h3>
      </div>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
              <tr>
                <td width="52%"><form action="stat_traitement_con_affichage_trie.php" method="post" name="testform" id="form3">
                  <strong>Ville</strong> :
                  <?Php
...
<strong>Quartier</strong>
                  ...
                  <input type="submit" name="Submit4" class="btn btn-sm btn-default" value="TRAITER" />
