...
<div class="panel panel-primary">
            ...
            <h3 class="panel-title">Service facturation (envoyer votre index)</h3>
            </div>
            <div class="panel-body">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="panel-body">
                <tr>
                  <td width="47%"><form name="form1" method="post" action="client_fact_save.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><input name="Facturation" type="text" disabled class="form-control" id="Facturation" value="FACTURATION" size="50" readonly></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        <td><span class="panel-title">Index  </span></td>
                        <td><input name="indexc" type="text" class="form-control" id="indexc" size="50"></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
