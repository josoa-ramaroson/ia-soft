...
<p>&nbsp;</p>
<a href="stk_gaz_recapitulatif_w_mois_detailimp.php?mois=<?php echo md5(microtime()).$mois;?>&annee=<?php echo md5(microtime()).$annee; ?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a>
            ...
            <td width="52%"><form action="" method="post" name="form5" id="form11">
              <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1">
                <tr >
                  ...
                  <td width="36%" align="center" ><font size="4"><strong>MOIS</strong></font></td>
