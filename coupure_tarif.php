  ...
  <tr>
    <td width="63%"><div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"> Liste des coupures par Ville selon la tarification</h3>
      </div>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
              <tr>
                <td width="52%"><form action="coupure_tarif_parville_NPaye.php" method="post" name="testform" id="form3" onSubmit="document.getElementById('loading').style.display='block'">
                  <strong>
