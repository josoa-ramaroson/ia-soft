...
$sql = "SELECT count(*) FROM $dbbk.z_"."$ARCH"."_$tbl_fact where st='F'  ";  
...
$sql = "SELECT * FROM $dbbk.z_"."$ARCH"."_$tbl_fact where st='F' ORDER BY idf desc LIMIT ".$_GET['debut'].",".$nb_affichage_par_page;  
...
mysqli_free_result ($req); 
   echo '<span class="gras">'.barre_navigation($nb_total, $nb_affichage_par_page, $_GET['debut'],$ARCH, 10).'</span>';  
}  
