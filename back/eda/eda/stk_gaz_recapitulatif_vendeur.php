...
$sql1="SELECT * FROM $tbl_vente  where id_nom='$id_nom' and type=1 ";
...
<?php
$sql2="SELECT datev, titre, id_nom,  SUM(Qvente) AS qtvendu , SUM(PTotal) AS prix  FROM $tbl_vente where   id_nom='$id_nom'  and type=1 GROUP BY id_nom";
