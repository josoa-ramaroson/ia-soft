...
?>
 <a href="z_rapport_agentimp.php?datec=<? echo md5(microtime()).$date;?>&agent=<? echo md5(microtime()).$agent;?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a></p>
