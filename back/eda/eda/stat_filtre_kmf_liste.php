...
{
$sql11 = "SELECT  v.cons1,  v.cons2,  v.cons,  v.mont1, v.mont2, v.puisct,  v.totalht,  v.tax,  v.totalttc,  v.ortc,  v.impayee,  v.Pre,  v.totalnet, v.refcommune , v.nserie , v.fannee , v.Tarif , v.st , v.RefLocalite, v.id , c.nomprenom FROM $tv_facturation v JOIN $tbl_contact c ON v.id=c.id and  fannee='$annee1f'  and nserie='$nserie1' and totalttc > '$CA' and  '$CB' > totalttc ORDER BY v.RefLocalite  ASC ";  
}
else
{
...
$sql11 = "SELECT  v.cons1,  v.cons2,  v.cons,  v.mont1, v.mont2, v.puisct,  v.totalht,  v.tax,  v.totalttc,  v.ortc,  v.impayee,  v.Pre,  v.totalnet, c.refcommune , v.nserie , v.fannee , c.Tarif , v.st , c.RefLocalite, v.id , c.nomprenom FROM 
 $dbbk.z_"."$ARCH"."_$tbl_fact v , $db.$tbl_contact c where  v.id=c.id and  v.fannee='$annee1f'  and v.nserie='$nserie1' and v.totalttc > '$CA' and  '$CB' > v.totalttc ORDER BY c.RefLocalite  ASC "; 
...
?>
  <tr>
    <td  bgcolor="#FFFFFF"><em><? echo $data11['id'];?></em></td>
    <td  bgcolor="#FFFFFF"><em>
      <? $RefLocalite=$data11['RefLocalite'];
...
echo $ville=$row322['ville'];
    ...
    <td  bgcolor="#FFFFFF"><em><? echo $data11['nomprenom'];?></em></td>
