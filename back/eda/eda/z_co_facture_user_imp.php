  ...
  <tr>
    <td height="130"><form action="re_enregistrement_save.php" method="post" name="form1" id="form1">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
           ...
           <tr>
                  <td width="11%" bgcolor="#FFFFFF"><? if ($_SESSION['u_niveau']==1) {?><a href="re_affichage_user.php?id=<? echo md5(microtime()).$datam['acid']; ?>" class="btn btn-sm btn-success">Aperçu du client</a><? } else {} ?></td>
...
?>
                  <tr>
                    <td align="center" bgcolor="#FFFFFF"><em><a href="<? if ($datam['Tarif']!=10){echo'z_co_billimp.php';} else { echo'z_co_billMTimp.php';}?>?idf=<? echo md5(microtime()).$rowsfac['idf'];?>&a=<? echo md5(microtime()).$ARCH;?>" target="_blank" ><? echo $rowsfac['nfacture'];?></a></em></td>
...
?>
      <tr>
        <td align="center" bgcolor="#FFFFFF"><em> <a href="z_paiement_billimp.php?idp=<? echo md5(microtime()).$rowsp['idp'];?>&a=<? echo md5(microtime()).$ARCH;?>" target="_blank" > <? echo $rowsp['idp'];?></a></em></td>
