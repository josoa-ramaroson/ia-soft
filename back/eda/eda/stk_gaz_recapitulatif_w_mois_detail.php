...
<p>&nbsp;</p>
<a href="stk_gaz_recapitulatif_w_mois_detailimp.php?mois=<? echo md5(microtime()).$mois;?>&annee=<? echo md5(microtime()).$annee; ?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a>
