<div style="padding:10px; width:440px"><a href="re_affichage_user.php?id=<? echo md5(microtime()).$datam['id'];?>" style="margin:0px; float:right"  class="btn btn-xs btn-danger" >Fermer</a>
