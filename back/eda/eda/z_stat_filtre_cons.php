...
?>
<body>
 <p><a href="stat_filtre_consimp.php?an=<? echo md5(microtime()).$annee1fl;?>&ns=<? echo md5(microtime()).$nserie1;?>&CA=<? echo md5(microtime()).$CA;?>&CB=<? echo md5(microtime()).$CB;?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a> 
...
?>
  <tr>
    <td  bgcolor="#FFFFFF"><a href="stat_filtre_cons_liste.php?an=<? echo md5(microtime()).$annee1fl;?>&ns=<? echo md5(microtime()).$nserie1;?>&CA=<? echo md5(microtime()).$CA;?>&CB=<? echo md5(microtime()).$CB;?>"  class="btn btn-sm btn-success" target="_blank"> LA LISTE</a></td>
