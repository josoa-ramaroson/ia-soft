...
?>
<body>
 <p><a href="stat_filtre_kmfsimp.php?an=<? echo md5(microtime()).$annee1f;?>&ns=<? echo md5(microtime()).$nserie1;?>&CA=<? echo md5(microtime()).$CA;?>&CB=<? echo md5(microtime()).$CB;?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a></p>
 <p>&nbsp;</p>
<p>&nbsp;</p>
<p>
  <?php 
...
?>
  <tr>
    <td  bgcolor="#FFFFFF"><a href="stat_filtre_kmf_liste.php?an=<? echo md5(microtime()).$annee1f;?>&ns=<? echo md5(microtime()).$nserie1;?>&CA=<? echo md5(microtime()).$CA;?>&CB=<? echo md5(microtime()).$CB;?>"  class="btn btn-sm btn-success" target="_blank"> LA LISTE</a></td>
