...
$sql5="SELECT * FROM $tbl_clientgaz c , $dbbk.z_"."$ARCH"."_$tbl_paiement p WHERE c.id=p.id and p.idp='$idp'";
...
<table width="100%" border="1">
  <tr>
    <td><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><span style="width:36%"><? echo $data5['idp'];?></span></td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
      <tr>
        <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
          <tr>
            <td width="76%">MONTANT TOTAL  :<em> <? echo $data5['montant'];?> </em>KMF</td>
          ...
          <tr>
            <td>MONTANT PAYE : <em><? echo $data5['paiement'];?> </em>KMF</td>
          ...
          <tr>
            <td>SOLDE A REPORTER :<em> <b><? echo $data5['report'];?> </> </em>KMF</td>
