  ...
  <tr> 
    <td><form name="form2" method="post" action="formationsupprime1_question.php">
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr bgcolor="#006ABE"> 
            <td width="10%" align="center"><font color="#CCCCCC" size="4"><strong>Date</strong></font><font color="#000000" size="3">&nbsp;</font></td>
            <td width="30%" align="center"><font color="#CCCCCC" size="3"><strong>Produit 
              </strong></font></td>
            <td width="18%" align="center"><font color="#000000" size="3">&nbsp;</font><font color="#CCCCCC" size="3"><strong>Validite</strong></font></td>
            <td width="14%" align="center"><font color="#CCCCCC" size="3"><strong>Quantite</strong></font></td>
            <td width="17%" align="center"><font color="#CCCCCC" size="3"><strong>Prix 
