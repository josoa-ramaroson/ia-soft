...
$tPT=$AFPT['montant'];
?>
<a href="app_aut_affichage_2date_service_imp.php?a=<?php echo md5(microtime()).$date1;?>&b=<?php echo md5(microtime()).$date2;?>&c=<?php echo md5(microtime()).$service;?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a>
