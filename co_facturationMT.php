     ...
     <td align="center" bgcolor="#FFFFFF"><form name="form2" method="post" action="co_facturationMT_save.php">
       <table width="100%" height="201" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
         ...
         <tr>
           ...
           <td>&nbsp;</td>
           <td><strong>
             <input class="form-control" name="coefTi" type="hidden"  id="coefTi" value="<?php echo $data['coefTi'];?>" size="20" />
           </strong></td>
           <td>&nbsp;</td>
           <td>&nbsp;</td>
           <td>&nbsp;</td>
         ...
         <tr>
           ...
           <td><font color="#FF0000">
             <input name="tmt" type="hidden" id="tmt" value="<?php echo $data['tmt']; ?>" />
