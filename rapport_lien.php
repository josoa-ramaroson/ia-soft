  ...
  <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
              <tr>
                <td width="52%"><form action="rapport_date.php" method="post" name="form3" id="form3">
                  <?php
    ...
    <td width="26%"><div class="panel panel-primary">
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="rapport_mois.php" method="post" name="form1" id="form1">
...
?>
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
              <tr>
                <td width="52%"><form action="rapport_datesecteur.php" method="post" name="form3" id="form6">
                  <?php
    ...
    <td width="29%"><div class="panel panel-primary">
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="rapport_agent.php" method="post" name="form2" id="form2">
              <?php
...
?>
  ...
  <tr>
    <td height="77"><div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"> Activité par date &amp; agent</h3>
      </div>
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
              <tr>
                <td width="52%"><form action="rapport_dateagent.php" method="post" name="form3" id="form4">
                  <?php
    ...
    <td><div class="panel panel-primary">
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="rapport_mois_ortc.php" method="post" name="form1" id="form8">
              Mois : <font color="#000000">
                <select name="mois" size="1" id="mois">
                  <option value="1">Janvier</option>
                  <option value="2">Février</option>
...
?>
              ...
              <input type="submit" name="valider8" id="valider7" value="Valider" />
            </form></td>
          </tr>
        </table>
      </div>
      ...
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
              <tr>
                <td width="52%"><form action="rapport_dateautre.php" method="post" name="form3" id="form7">
                  <?php
					  ...
					  ?>
                  &nbsp;
                  <input type="submit" name="valider7" id="valider6" value="Valider" />
                </form></td>
              </tr>
            </table></td>
          </tr>
...
<input type="submit" name="valider2" id="valider2" value="Valider" />
  ...
  <tr>
    <td height="77"><div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"> ORTC / TAX- ANNEE</h3>
      </div>
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="rapport_annee_ortc_tax.php" method="post" name="form1" id="form10">
              Mois :<font color="#000000">
                  <select name="annee" size="1" id="annee">
                    <?php
$sql81 = ("SELECT * FROM annee  ORDER BY annee ASC ");
...
?>
              ...
              <input type="submit" name="valider10" id="valider10" value="Valider" />
            </form></td>
          </tr>
        </table>
      </div>
    ...
    <td><div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"> ORTC / TAX - MOIS </h3>
      </div>
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><form action="rapport_mois_ortc_tax.php" method="post" name="form1" id="form9">
              Mois : <font color="#000000">
                <select name="mois" size="1" id="mois">
                  <option value="1">Janvier</option>
                  <option value="2">Février</option>
...
?>
              ...
              <input type="submit" name="valider9" id="valider8" value="Valider" />
            </form></td>
          </tr>
        </table>
      </div>
...
<div class="panel panel-warning">
  <div class="panel-heading">
    <h3 class="panel-title">ARCHIVES  DES RAPPORTS</h3>
  </div>
  <div class="panel-body">
      <a href="z_rapport.php" class="btn btn-sm btn-warning" > LES ARCHIVES</a> |
  </div>
</div>