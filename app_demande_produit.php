...
<div class="panel-body">
  <form name="form1" method="post" action="app_demande_produit_save.php">
...
<div class="panel-heading">
  <h3 class="panel-title">LISTE DES DEMANDES  <a href="app_demande_imp.php?<?php echo md5(microtime());?>&id=<?php echo md5(microtime()).$datam['id_dem'];?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a></h3>
</div>
<p>
  <?php
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#ffffff">
    ...
    <td width="11%">&nbsp;</td>
    <td width="11%"><?php echo $rowsact['fournisseur']; ?></td>
    <td width="12%"></td>
    <td width="11%"><a href="app_demande_produit_cancel.php?id=<?php echo md5(microtime()).$rowsact['id_dp'];?>&ids=<?php echo md5(microtime()).$rowsact['id_dem'];?>" class="btn btn-xs btn-danger" onClick="return confirm('Etes-vous sûr de vouloir supprimer ')" ; style="margin:5px" >Supprimer</a></td> 
  </tr>
</table>
<p>
  <?php }
