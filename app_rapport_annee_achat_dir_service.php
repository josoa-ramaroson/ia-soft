...
?>
        <tr bgcolor=<?php echo "$bgcolor" ?>>
          ...
          <td width="26%">
          <a href="app_rapport_annee_achat_dir_service_detail.php?id=<?php echo md5(microtime()).$annee; ?>&dr=<?php echo $rows2['direction'];?>&sr=<?php echo $rows2['service']; ?>" class="btn btn-xs btn-success" onclick="return !window.open(this.href, 'pop', 'width=1200,height=670,left=120,top=120');"> Detail </a>
          </td>
        </tr>
		  <?php
$numboucle++;
