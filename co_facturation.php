...
<body>
 <table width="100%" border="0">
   <tr>
     <td width="42%"><a href="co_facturation_listeFac.php" class="btn btn-sm btn-success" > LISTE DES FACTURATIONS BT </a> | <a href="co_facturation_listeNoFac.php" class="btn btn-sm btn-success" > LISTE DES  BT NON FACTURE </a> </td>
