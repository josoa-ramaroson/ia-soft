...
<table width="100%" border="0">
  <tr>
    <td width="54%"><div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"> Envoi des SMS par Ville et Quartier</h3>
      </div>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
              <tr>
                <td width="52%"><form action="sms_coupure_NPaye.php" method="post" name="testform" id="form3" onSubmit="document.getElementById('loading').style.display='block'">
                  <strong>Ville</strong> :
                  <?Php
...
<strong>Quartier</strong>
    ...
    <td width="2%">&nbsp;</td>
    <td width="10%"><div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title">MASS - SMS</h3>
      </div>
      <div class="panel-body">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
...
<p><img src="images/loading.gif" id="loading" style="display:none"></p>
