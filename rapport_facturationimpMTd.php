...
?>
<H2> <p align="center" >  RECAPITULATIF FACTURATION DETAILLE MT PAR SECTEUR  <?php echo $nserie.'/'.$anneec; ?></p> </H2>
...
<H2>
  <p align="center" > FACTURATION DETAILLE MT TOTAL <?php echo $nserie.'/'.$anneec; ?></p>
</H2>
<table width="100%" border="1" align="center" cellpadding="1" cellspacing="0" bgcolor="#CCCCCC">
  <tr bgcolor="#3071AA">
