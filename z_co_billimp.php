    ...
    <td width="57%"><table width="100%" border="1">
      <tr>
        <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td>ID Client :</td>
            <td><span style="width:36%"><?php $Codebare=$data5['id'];  echo $data5['id'];?>
               Type de compteur :<?php echo $data5['typecompteur'];?></span></td>
          </tr>
          <tr>
            <td></td>
  ...
  <div class="panel-body">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
      <tr>
        <td width="47%"><table width="100%" border="0.5" cellspacing="0" cellpadding="0">
          <tr>
            <td width="16%"><img src="z_codeqrfonction_fact.php?qr=<?=$Codebare?>&idf=<?=$idf?>&a=<?php echo md5(microtime()).$ARCH;?>" width="100" height="100"/></td>
      ...
      <tr>
        <td width="47%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td><span style="width:36%"><strong><?php echo $data5['id'];?></strong></span></td>
            <td><span style="width:36%"><?php echo $data5['ncompteur'];?></span></td>
          </tr>
        </table></td>
      </tr>
