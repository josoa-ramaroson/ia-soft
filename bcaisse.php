...
<table width="96%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="panel-body">
                <tr>
                  <td width="43%"><div class="panel panel-info">
                    <div class="panel-heading">
                      <h3 class="panel-title"> <em> <h1> ETAPE 1 : Choisir la date </h1>
                      </h3>
                    </div>
                    <div class="panel-body">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                        <tr>
                          <td width="47%"><form name="testform" method="post" action="bcaisse_tmp_save.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  $myCalendar->setYearInterval($annee, $annee);
    ...
    $datesurv=$verification['date'];
                        ...
                        <td><input type="submit" name="Submit2" value="Enregistrement" class="btn btn-primary" ></td>
                      </tr>
                    </table>
                  </form></td>
                        </tr>
                  ...
                  <td width="9%">&nbsp;</td>
                  <td width="48%"><div class="panel panel-success">
                    <div class="panel-heading">
				...
				$datecaisseT=$dataCtmp['datecaisseT'];
					 ...
					 ?>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                        <tr>
                          <td width="47%"><form name="form2" method="post" action="bcaisse_save.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="32%">&nbsp;</td>
                        <td width="68%">&nbsp;</td>
    ...
    $datesurv=$verification['date'];
                        ...
                        <td><input type="submit" name="Submit" value="CONFIRMATION" class="btn btn-success" ></td>
                      </tr>
                    </table>
                  </form></td>
                        </tr>
...
<script language="JavaScript" type="text/javascript" xml:space="preserve"> 
	...
	frmvalidator.addValidation("date","dontselect=0000-00-00");
